...
<section class="videos p-3 p-md-4 p-xl-5">
  <div class="container">
        ...
        <div class="col-12 col-md-6 text-bg-primary">
          <div class="d-flex align-items-center justify-content-center h-100">
            <div class="col-10 col-xl-8 py-3">
              <img class="img-fluid rounded mb-4" loading="lazy" src="https://bootstrapbrain.com/demo/components/logins/login-5/assets/img/bsb-logo-light.svg" width="245" height="80" alt="BootstrapBrain Logo" />
            ...
            <form action="#!">
              <div class="row gy-3 gy-md-4 overflow-hidden">
                ...
                <div class="col-12">
                  ...
                  <input type="password" class="form-control" name="password" id="password" defaultValue="" required />
                </div>
                <div class="col-12">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" defaultValue="" name="remember_me" id="remember_me" />
